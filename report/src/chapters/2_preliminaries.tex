...
Giả sử rằng tập nghiệm của $(OP(f,C))$ là không rỗng. Trước hết, ta nhắc lại một số định nghĩa và kết quả cơ bản sẽ được sử dụng trong phần tiếp theo của bài báo. Chứng minh chi tiết được trình bày trong \cite{bauschke2011convex} và \cite{rockafellar1970convex}. Với $x\in\mathbb{R}^{m}$ ký hiệu bởi $P_{C}(x)$ là hình chiếu của $x$ lên $C$, tức là:
\begin{equation}
